                        ...
                        <div class="row g-4">
                            ...
                            while ($row = mysqli_fetch_assoc($result_query)) {
                                ...
                                <div class='col-lg-6'>
                                    <div class='rounded'>
                                        <a href='$p_img'>
                                            <img src='$p_img' class='img-fluid border rounded' alt='Image' style='margin-left:3rem !important;'>
                                        </a>
                                    </div>
                                </div>
                                <div class='col-lg-6'>
                                <h4 class='fw-bold mb-3'>$product_name</h4>
                                <p class='mb-3'>Category: $category</p>
                                <h5 class='fw-bold mb-3'>₹ $price</h5>
                                <div class='d-flex mb-4'>
                                </div>
                                <p class='mb-4'>$small_description</p>
                        ...
                        <div class='row g-4 fruite'>
                            ...
                            <div class='col-lg-12'>
                                <div class='position-relative'>
                                    <img src='assets/img/shopdetail.jpg' class='img-fluid w-100 rounded' alt=''>
