...
if (isset($_GET['user_id'])) {
    ...
    // If user ID is not present, redirect to login or wherever appropriate
}

// Logic to retrieve products from the database and display them on the shop page

// Check if there's a success message in the session
if(isset($_SESSION['success_message'])) {
    echo "<script>alert('".$_SESSION['success_message']."')</script>";
    unset($_SESSION['success_message']); // Remove the message from session to avoid displaying it again on page refresh
}
...
<body>
    ...
    <div class="container-fluid fruite py-5">
        <div class="container py-5">
            <h1 class="mb-4">Jewellery Collection</h1>
            <div class="row g-4">
                <div class="col-lg-12">
                    <div class="row g-4">
                        <!-- <div class="col-xl-3">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <h4>Categories</h4>
                                        <ul class="fruite-categorie">
                                        <a href="shop-cat.php?category='necklace'&user_id=<?php echo $user_id; ?>"><li>
                                                 <div class="d-flex justify-content-between fruite-name">
                                                    Necklace
                                                    <span>(30)</span>
                                                </div>
                                            </li></a>
                                            <a href="shop-cat.php?category='earrings'&user_id=<?php echo $user_id; ?>"><li>
                                                <div class="d-flex justify-content-between fruite-name">
                                                    Earrings
                                                    <span>(20)</span>
                                                </div>
                                            </li></a>
                                            <a href="shop-cat.php?category='pendant'&user_id=<?php echo $user_id; ?>"><li>
                                                <div class="d-flex justify-content-between fruite-name">
                                                    Pendant
                                                    <span>(30)</span>
                                                </div>
                        ...
                        <div class="col-lg-9">
                            ...
                            $select_query = "Select * from product_detail where  category= $category";  //add the
                            ...
                            echo "
                            <div class='col-md-6 col-lg-6 col-xl-4'><a href='shop-detail.php?product_id=$product_id&user_id=$user_id'>
